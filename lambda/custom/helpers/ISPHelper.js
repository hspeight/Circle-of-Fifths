...
exports.getProductByRef = function (purchasableProducts, productRef) {

  // use the product ref to get the purchasable product
  return purchasableProducts.filter(record => record.referenceName === productRef);
...
exports.getPurchasableProduct = function(purchasableProducts, productId) {
  ...
  //return the purchasable product for productId
