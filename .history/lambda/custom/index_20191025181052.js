    ...
    async handle(handlerInput) {
        ...
        switch (attributes.skillState) {
            ...
            case states.ENDOFDRILLWITHREPLAY:
                console.log('+++++++++++++++++++++++++++++++++++++++++++++++=== END OF DRILL WITH REPLAY ++++++++++++++++++++++++++++++++++');
                ...
                handlerInput.attributesManager.getPersistentAttributes()
                    .then((persistentAttributes) => {
                        ...
                        if (!persistentAttributes.launchCount) { // first ever launch
                            // create a dynamodb record with the launchcount set to 1
                            persistentAttributes.veryFirstLaunch = true;
...
const PersistenceResponseInterceptor = {
    process(handlerInput, response) {
        ...
        if ((r.type === 'SessionEndedRequest') ||
                ...
                sessionAttributes.veryFirstLaunch === true) {

            sessionAttributes.veryFirstLaunch = false;
