...
const drillSetup = require('./drillSetup/perfect-intervals');
...
function setupLevel(handlerInput) {
    ...
    switch (attributes.drillRef) {
        case 'perfect-intervals':
            QANDA = setupDrill_PerfectIntervals(attributes);
            break;
        case 'relative-keys':
            QANDA = setupDrill_RelativeKeys(attributes);
            break;
        case 'key-signatures':
            QANDA = setupDrill_KeySignatures(attributes);
            break;
        default:
