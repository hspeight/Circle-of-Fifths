...
module.exports = {
    translation : { 
        ...
        'ASP_END_OF_DRILL' : [
            'Congratulations, you have completed the %s drill'
        ],
        'ASK_IF_READY' : [
        ...
        'PERFECT_INTERVALS_SUMMARY': [
            'The perfect intervals pack contains drills that will test you on the perfect fourth and perfect fifth intervals. '
        ],
        'SWITCH_DRILL': [
        ...
        'END_OF_DRILL' : [
            ...
            'You have completed all levels of the %s drill. Would you like to hear about the next drill which is called %s?'
