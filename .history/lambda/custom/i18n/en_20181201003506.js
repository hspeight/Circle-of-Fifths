...
module.exports = {
    translation : {
        ...
        'VALID_TEST' : [
            'fourths', 'fifths', 'mixed', '4ths', '4th', '5ths', '5th', 'pick', 'any', 'choose', 'either', 'mix', 'mixture', 'start'     
        ],
        'SKILL_NAME' : [
            'Circle of Fifths'
        ],
        ...
        'COF_EXPLANATION' : [
            ...
            'A circle of fifths diagram can be seen at www.tech ros.info slash circle, that\'s <say-as interpret-as="spell-out">techros</say-as> dot info slash circle.'
        ],
        'END_GAME_MESSAGE_1' : [
