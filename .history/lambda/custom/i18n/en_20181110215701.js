...
module.exports = {
    translation : {
        ...
        'RELQUESTIONS_4ths' : [
            '0,what is the fourth of <emphasis level="strong">X</emphasis>?',
            '1,what is <emphasis level="strong">X</emphasis> the fourth of?'
        ],
        'RELQUESTIONS_5ths' : [
            '2,what is the fifth of <emphasis level="strong">X</emphasis>?',
            '3,what is <emphasis level="strong">X</emphasis> the fifth of?'
        ],
    }
}