...
module.exports = {
    translation : {        
        ...
        'WELCOME_MESSAGE_FIRST_TIME_REP' : [
            'You can say help at any time for more information. Are you ready to start the perfect fourths drill?'
        ],
        'WELCOME_BACK' : [
            'Welcome back to ' + SKILLNAME + ' . This is the %s drill, and you are on level %s. ',
        ],
        'WELCOME_BACK_DRILL-COMPLETE' : [
                'Welcome back to ' + SKILLNAME + '. This is the %s drill which you have completed. Would you like to replay it? ',
        ],
        'WELCOME_A' : [
            '! and '
        ],
