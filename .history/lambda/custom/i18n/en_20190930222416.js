...
module.exports = {
    translation : { 
        'FIRST_TIME' : [
            'Welcome to the circle of fifths skill. I\'m going to ask you some questions in a series of drills that will help you to learn all about the circle of fifths. ' +
            'Each drill will contain a number of levels that increase in difficulty. You will need to scroe one hunderd percent on each level in order to complete the drill. ' +
