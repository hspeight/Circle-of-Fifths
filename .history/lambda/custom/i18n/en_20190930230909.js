...
module.exports = {
    translation : { 
        ...
        'HELP_MESSAGE_LONG': [
            'The circle of fifths, also known as the circle of fouurths, is a musical construct that describes the relationship between chords, keys, and scales. ' +
            'This skill offers a way to help learn about the circle through a questions grouped into drills. ' +
            'The drills currently available are %s. To open a drill pack you can say play and then the name of the drill pack. For example play key signatures. '
        ],
        'HELP_MESSAGE_SHORT': [
