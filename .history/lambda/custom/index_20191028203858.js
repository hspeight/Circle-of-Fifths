    ...
    async handle(handlerInput) {
        ...
        switch (attributes.skillState) {
            ...
            case states.ENDOFDRILLWITHUPSELL:
                return makeUpsell('OK.', getNextPurchasableProduct(handlerInput), handlerInput); // offer the first available purchaseable product. whhat if there are none left to buy???7    
            default:
