...
const questionTempltes = {
    ...
    relativeKeyQuestions: {
        minor: ['what is the relative minor of [key] ?', 'what is [key] the relative minor of ?'], // convert to requestattribue'],
        major: ['what is the relative major of [key] ?', 'what is [key] the relative major of ?']
    }
}
