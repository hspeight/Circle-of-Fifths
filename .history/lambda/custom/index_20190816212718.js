...
const BuyPackIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        console.log('handlerInput.requestEnvelope.request.intent.slots.productCategory.resolution.resolutionsPerAuthority[0]=' 
                    + handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority[0]);
