...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (attributes.launchCount === 1) {
            ...
            // upsell the next 
            return makeUpsell('all righty.', getNextPurchasableProduct(attributes.purchasableProducts), handlerInput); // offer the first available purchaseable product. whhat if there are none left to buy???
        } else {
