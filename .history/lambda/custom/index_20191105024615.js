...
const IWantToPlayHandler = {
    ...
    handle(handlerInput) {
        ...
        let packName = handlerInput.requestEnvelope.request.intent.slots.packToPlay.value;
        if (packName === freePackName) {
            attributes.currentDrillRef = packRef; // rethink required
            return setupLevel(handlerInput);
        }
