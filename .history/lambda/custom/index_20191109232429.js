...
function setupLevel(handlerInput) {
    ...
    if (supportsAPL(handlerInput)) {
        ...
        data.bodyTemplate7Data.text.packName = APLTitle;
        return handlerInput.responseBuilder
            .speak(speechOutput)
            .reprompt(repromptOutput)
            .addDirective({
...
const PurchaseHistoryHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (supportsAPL(handlerInput)) {
            ...
            console.log('dataPurchaseHistory.bodyTemplate1Data.textContent.primaryText.text=' + dataPurchaseHistory.bodyTemplate1Data.textContent.primaryText.text);
