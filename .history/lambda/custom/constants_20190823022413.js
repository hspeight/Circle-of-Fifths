...
const questionTempltes = {
    ...
    relativeKeyQuestions: {
        major: ['what is the relative minor of [key] ?', 'what is [key] the relative minor of ?'], // convert to requestattribue'],
        minor: ['what is the relative major of [key] ?', 'what is [key] the relative major of ?']
    }
}
