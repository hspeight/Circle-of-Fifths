...
const BuyPackIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        console.log('handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions=' + handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions);
