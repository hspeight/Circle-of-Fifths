        ...
        .addDirective({
            ...
            payload: {
                InSkillProduct: {
                    ...
                    productId: purchasableProduct[0].productId
                },
...
const BuyPackIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority[0].values.filter(r => (r.value.id === requestedPack)).length > 1) {
...
/*
	"request": {
		"type": "IntentRequest",
		"requestId": "amzn1.echo-api.request.18a7e9ee-edbf-4746-8778-a012a3c34171",
		"timestamp": "2019-08-17T00:11:17Z",
		"locale": "en-GB",
		"intent": {
			"name": "BuyPackIntent",
...
console.log(product);
                ...
                switch (handlerInput.requestEnvelope.request.payload.purchaseResult) {
                    case 'ACCEPTED':
                        ...
                        break;
                    case 'DECLINED':
                        speechOutput = requestAttributes.t('PACK_DECLINED_MSG1') + requestAttributes.t('PACK_DECLINED_MSG2', product[0].name);
                        break;
...
const TellMeMoreAboutPackIntentHandler = {
    ...
    handle(handlerInput) {
      ...
      return monetizationClient.getInSkillProducts(locale).then((res) => {
        ...
        return makeUpsell('Sure.', product, handlerInput);
