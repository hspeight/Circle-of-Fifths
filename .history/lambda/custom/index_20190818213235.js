...
function setupLevel(handlerInput, STATE_IN) {
    ...
    const drillLevels = drills[attributes.drill - 1]['levels'].length;
...
function marksOutOfTen(handlerInput) {
    ...
    if (percentScore > 99) {
        ...
        console.log('attributes.drillStatus[0].drill.level ' + attributes.drillStatus[0].drill.level + '/' + attributes.drill + '/' + drillLevels);
