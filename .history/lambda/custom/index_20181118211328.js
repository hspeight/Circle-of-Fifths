...
//console.log('starting with circlekeys=' + circleKeys);
...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        const attributes = await handlerInput.attributesManager.getPersistentAttributes(); // <--dynamodb
        if (typeof attributes.questionsPerTest === 'undefined') {
            attributes.questionsPerTest = 4;
            handlerInput.attributesManager.setPersistentAttributes(attributes);
            await handlerInput.attributesManager.savePersistentAttributes();
        }
       
        numQuestions = attributes.questionsPerTest;
...
async function exitSkill(pHandlerInput) {
  ...
  //console.log('exitskil attributes.skillState=' + attributes.skillState);  
    if (attributes.skillState === states.QUIZ) {
        response.withSimpleCard(skillName + ' - early end!', printCardInfo(pHandlerInput)); // needs attention
    }

    await pHandlerInput.attributesManager.savePersistentAttributes();
