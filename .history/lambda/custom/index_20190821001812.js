...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (attributes.launchCount == 1) {
            ...
            speechOutput = requestAttributes.t('WELCOME_BACK', attributes.currentDrill, attributes.currentlevel) +
...
function setupLevel(handlerInput, STATE_IN) {
    ...
    attributes.currentDrill = drills.map(function(e) { return e.ref; }).indexOf(attributes.drillRef); // get the position in the drills array for this ref
