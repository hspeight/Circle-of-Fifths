...
var circleKeys = [
    ...
    //['a flat', 'd flat', 'e flat', '0', '4','f'], // 4th is c sharp or d flat
    //['d flat', 'g flat', 'a flat', '0', '5', 'b flat'],
    //['g flat', 'b', 'd flat', '0', '6', 'e flat'],
    //['b', 'e', 'g flat', '5', '0', 'g sharp'],
    //['e', 'a', 'b', '4', '0', 'c sharp'], // 5th is b or c flat
    //['a', 'd', 'e', '3', '0', 'f sharp'],
    //['d', 'g', 'a', '2', '0', 'b'],
    //['g', 'c', 'd', '1', '0', 'e'],
    ['c sharp', 'g flat or f sharp', 'a flat', '7', '0', 'a sharp'],
    //['f sharp', 'b or c flat', 'd flat or c sharp', '6', '0', 'd sharp'],
...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        console.log('getPersistentAttributes attributes=' + attributes);

        let { numQ } = attributes;
        //let speechText = '';

        if (typeof numQ === 'undefined') {
            console.log('No number set yet');
        } else {
            console.log(numQ); 
        }
