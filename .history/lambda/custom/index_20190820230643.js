...
function setupLevel(handlerInput, STATE_IN) {
    ...
    if (attributes.drillStatus.filter(function (drill) {
            ...
            console.log('PPPPUUUSSSHHHIIINNGGG');
    ...
    consold.log('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh');
                ...
                switch (handlerInput.requestEnvelope.request.payload.purchaseResult) {
                    case 'ACCEPTED':
                        ...
                        attributes.drillRef = newProd[0].referenceName;
                                ...
                                console.log(attributes.drillRef);
                        var qta = setupLevel(handlerInput, states.START); // requires attention
                        speechOutput = requestAttributes.t('STARTER2', attributes.drillRef + ', ', 1 + ', ') + qta;
                        break;
                    case 'DECLINED':
                        speechOutput = requestAttributes.t('PACK_DECLINED_MSG1') + requestAttributes.t('PACK_DECLINED_MSG2', attributes.drillRef);
                        break;
