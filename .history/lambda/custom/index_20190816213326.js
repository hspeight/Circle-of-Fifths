...
const BuyPackIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        console.log('handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority[0].values.value.id=' 
                    + handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority[0].values.value.id);
