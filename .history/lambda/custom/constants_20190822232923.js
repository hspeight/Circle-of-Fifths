...
const drills = [
    perfectIntervals = {
        ...
        levels: [
            {'interval': 'fifths', 'data': ['B FLAT MAJOR']},
            {'interval': 'fourths', 'data': ['B MAJOR']},
    ...
    relativeKeys = {
        ...
        ref: 'relative-keys',
        levels: [
            {'relative': 'major', 'data': ['C MINOR', 'F SHARP MINOR']}, // what is the relative minor
...
const relativeKeyQuestions = {
    major: ['what is [key] the relative [quality] of ?'], // convert to requestattribue?
    minor: ['what is the relative [quality] of [key] ?']
}
