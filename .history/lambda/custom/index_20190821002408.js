...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (attributes.launchCount == 1) {
            ...
            speechOutput = requestAttributes.t('WELCOME_BACK', drills[attributes.currentDrill].ref, attributes.currentlevel) +
...
function setupLevel(handlerInput, STATE_IN) {
    ...
    var roundData = drills[attributes.currentDrill]['levels'][attributes.currentlevel - 1]; // drill/round
    ...
    attributes.roundLength = drills[attributes.currentDrill]['levels'][attributes.currentlevel - 1]['data'].length; // Number of questions in the round
