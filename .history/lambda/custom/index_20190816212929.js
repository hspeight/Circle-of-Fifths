...
const BuyPackIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        console.log('handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority.authority=' 
                    + handlerInput.requestEnvelope.request.intent.slots.productCategory.resolutions.resolutionsPerAuthority.authority);
