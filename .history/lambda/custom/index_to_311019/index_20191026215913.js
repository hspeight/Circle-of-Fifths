...
function CheckAnswer(handlerInput, answerIn) {
    ...
    if (enharmonic.includes(answerIn)) { // does the given answer match the actual answer?
        attributes.levelScore += 1;
        return requestAttributes.t('CORRECT_ANSWER');
    } else {
        return '<audio src="https://s3-eu-west-1.amazonaws.com/circle-of-fifths/wrong-answer.mp3"/>';
    }
