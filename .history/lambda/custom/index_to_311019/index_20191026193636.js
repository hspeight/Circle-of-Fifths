...
function setupLevel(handlerInput) {
    ...
    if (idx === undefined) {
        ...
        attributes.currentLevel = attributes.drillStatus[idx]; // get the current level as recorded in drillstatus
    }
    ...
    attributes.levelData = getLevelData(attributes.currentDrillRef, attributes.currentLevel);
