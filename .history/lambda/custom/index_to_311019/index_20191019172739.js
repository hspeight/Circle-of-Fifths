...
//console.log('DRILL LEVEL ================ ' + attributes.drillStatus[attributes.drillStatusIndex].drill.level + ' and state is ' + attributes.skillState);
    ...
    // needs attention. currentlevel is being incremented incorrectly.
    //if (attributes.skillState != states.REPLAYLEVEL) {
    //    attributes.currentLevel += 1;
    //}
    ...
    switch (attributes.currentDrillRef) {
        case freePackRef: // perfect intervals
            ...
            break;
        case 'relative-keys':
            QANDA = drillSetup.setupDrill_RelativeKeys(attributes, handlerInput.requestEnvelope.context.System.user.userId);
            console.log('QAQAQAQAQAQAQAQAQAQA');
            console.log(QANDA);
            console.log('QAQAQAQAQAQAQAQAQAQA');
            break;
        case 'key-signatures':
            QANDA = drillSetup.setupDrill_KeySignatures(attributes, handlerInput.requestEnvelope.context.System.user.userId);
            break;
        default:
