...
function askQuestion(handlerInput) {
    ...
    const questionToAsk = `<audio src="https://s3-eu-west-1.amazonaws.com/circle-of-fifths/wrong-answer.mp3"/> Question ${attributes.questionNum}. ${QUESTIONS[attributes.questionNum -1]}`;
