...
const AnswerHandler = {
    ...
    handle(handlerInput) {
        ...
        //return CheckAnswer(handlerInput, str);
        return askQuestion(handlerInput, '');

        qta = CheckAnswer(handlerInput, str);
        console.log('QTTA=');
        console.log(qta);
        //return qta;
        //return CheckAnswer(handlerInput, str);
        ...
        showNextQuestion(handlerInput);

        /*
        return response.speak(speech.speech)
...
function showNextQuestion(handlerInput) {
    const attributes = handlerInput.attributesManager.getSessionAttributes();
    const requestAttributes = handlerInput.attributesManager.getRequestAttributes();
...
function CheckAnswer(handlerInput, answerIn) {
    ...
    if (attributes.questionNum < QUESTIONS.length) { // Number of keys in the array for this round
        ...
        //speech.speech += " oh no!";
        return  askQuestion(handlerInput, speech.speech);
...
function askQuestion(handlerInput, prevResponse) {
    ...
    const questionToAsk = `${prevResponse}. Question ${attributes.questionNum}. ${QUESTIONS[attributes.questionNum -1]}`;
