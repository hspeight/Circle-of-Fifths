...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        console.log('launch - DRILL LEVEL ================ ' + handlerInput.attributesManager.getSessionAttributes().drillStatus[attributes.drillStatusIndex].drill.level);
            ...
            switch (attributes.skillState) {
                case states.REPLAYLEVEL:
                    ...
                    case states.ENDOFLEVEL:
                        dataNextQuestion.bodyTemplate7Data.text.question = 'End of level';
                        break;
