        ...
        dataNextQuestion.bodyTemplate7Data.text.level = requestAttributes.t('LEVEL_TXT', attributes.drillStatus[attributes.drillStatusIndex].drill.level,
            ...
            switch (attributes.skillState) {
                case states.REPLAYLEVEL:
                    dataNextQuestion.bodyTemplate7Data.text.question = 'Replay the level?';
                    break;
    ...
    async handle(handlerInput) {
        ...
        switch (attributes.skillState) {
            ...
            case states.ENDOFLEVEL:
                    ...
                    speechOutput = requestAttributes.t('START_LEVEL_MSG', attributes.currentDrillName, attributes.drillStatus[0].drill.level +1) +
