        ...
        dataNextQuestion.bodyTemplate7Data.text.level = requestAttributes.t('LEVEL_TXT', attributes.drillStatus[attributes.drillStatusIndex].drill.level,
            ...
            switch (attributes.skillState) {
                case states.REPLAYLEVEL:
                    dataNextQuestion.bodyTemplate7Data.text.level = requestAttributes.t('ASP_LEVEL_SCORE', attributes.drillStatus[attributes.drillStatusIndex].drill.level,
                    ...
                    case states.ENDOFLEVEL:
                        dataNextQuestion.bodyTemplate7Data.text.level = 'Level x of y';
                        dataNextQuestion.bodyTemplate7Data.text.question = 'Level Completed';
                        break;
                    case states.ENDOFDRILLWITHUPSELL:
                        dataNextQuestion.bodyTemplate7Data.text.level = 'Level x of y';
                        dataNextQuestion.bodyTemplate7Data.text.question = 'Congratulations, you have completed the named drill';
                        break;
                default:
