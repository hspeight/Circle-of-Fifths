...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        speechOutput = 'Welcome to circle of fifths. My aim is to make you a circle ninja. ' +
                        'Your first drill is called perfect fifths. I will give you a key on the circle of fifths and ask you to ' +
                        ' name the key that is a perfect fifth away. Here we go.';
