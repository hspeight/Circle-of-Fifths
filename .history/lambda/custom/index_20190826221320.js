...
function setupLevel(handlerInput) {
    ...
    //console.log('set up level ********************************************* for ' + attributes.drillRef);
    const attributes = handlerInput.attributesManager.getSessionAttributes();
    ...
    attributes.currentDrill = drills.map(function (e) {
        return e.ref;
    }).indexOf(attributes.drillRef); // get the position in the drills array for this ref. Should always find it.
    ...
    attributes.currentLevel = attributes.drillStatus[(attributes.drillStatus.map(function(e) { return e.drill.ref; }).indexOf(attributes.drillRef))].drill.level;
