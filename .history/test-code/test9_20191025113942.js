...
//let PP = purchasableProducts.filter((e) => e.referenceName === 'key-signatures')[0];
//if (purchasableProducts.length > 0) {
//    console.log(purchasableProducts[0].referenceName);
//}
/*
...
if (LEV !== undefined) {
    ...
    console.log(str);
    attributes.drillStatus.push(JSON.parse(str));
}
console.log(attributes.drillStatus);
