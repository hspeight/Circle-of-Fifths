...
let newEntitledProduct = (ISPHelp.getEntitledProduct(ent.entitledProducts, 'amzn1.adg.product.ac798b5e-fb3d-4e44-bbed-60b2be0cd014')).name;
console.log(newEntitledProduct);
