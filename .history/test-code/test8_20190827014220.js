...
const attributes = {
    ...
    attributes.drillStatusIndex = attributes.drillStatus.map(function(e) { return e.ref; }).indexOf(attributes.currentDrillRef); // get the index position in the drills array
    console.log(attributes.currentDrill);
