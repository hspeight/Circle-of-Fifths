...
function getAnswer(nextKey) {
    ...
    switch (levelProp) {
        case 'relKey':
            QU = circleWithEnharmonics[indexOfKey][quality];
            QUESTION = relativeKeyQuestions[QU][Q].replace(/\[key\]/g, nextKey); // replace placeholder with the key
            ANSWER =  circleWithEnharmonics[indexOfKey][relKey];
            break;
        case 'fourth':
        case 'fifth':
