...
var prod = { launchCount: 2,
    roundCount: 0,
    drillStatus: [ { drill: [Object] } ],
    ...
    entitledProducts:
     [ { productId: 'amzn1.adg.product.ac798b5e-fb0d-4e44-bbed-60b2be0cd014',
         ...
         purchaseMode: 'TEST' } ],
    lastUseTimestamp: 1566499976000
}

myProd = { productId: 'amzn1.adg.product.e8b05e85-a615-41f6-b912-071a768dc51f',
referenceName: 'relative-keys',
type: 'ENTITLEMENT',
name: 'Relative Keys',
summary: 'The relative Key pack is a drill that will help you to learn relative major and minor keys on the circle of fifths',
...
for (var i = 1; i < drills.length; i++) {
    ...
    var h = prod.purchasableProducts.filter(function(p) { return p.referenceName === drills[i].ref });
    if (typeof h[0].referenceName !== 'undefined') {
        console.log(h[0]);
    }
}
