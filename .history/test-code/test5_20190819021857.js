...
if (drillsStatus.filter(function(drill) { return drill.id === "relative-kes" })) {
    console.log('exists');
    console.log(drillsStatus.filter(function(drill) { return drill.id === "relative-kes" })[0].packName);
} else {
