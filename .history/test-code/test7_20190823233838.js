...
for (i = 0; i < levelArray.length; i++) {
    ...
    var sharps = circleWithEnharmonics[pos].keyInfo.intervals.hasOwnProperty('sharps') ? circleWithEnharmonics[pos].keyinfo.signature.sharps : 0;
    var flats = circleWithEnharmonics[pos].keyInfo.intervals.hasOwnProperty('flats') ? circleWithEnharmonics[pos].keyinfo.signature.flats: 0;
