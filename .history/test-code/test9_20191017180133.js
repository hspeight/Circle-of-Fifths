...
attributes.drillStatus.push(JSON.parse('{"drill": "perfect-intervals0", level":  0, "completed": false}'));

let LEV = attributes.drillStatus.filter((e) => e.drill === 'perfect-intervals0')[0];
if (LEV !== undefined) {
