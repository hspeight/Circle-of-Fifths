    ...
    switch (levelProp) {
        ...
        case 'mixed-sig':
           ...
           // QUESTION = keySignatureQuestions[levelProp][Q].replace(/\[number\]/g, num).replace(/\[sign\]/g, sign);
            QUESTION = Q === 0 ? keySignatureQuestions['X'][Q].replace(/\[number\]/g, num).replace(/\[number\]/g, num).replace(/\[sign\]/g, sign) :
                             keySignatureQuestions['X'][Q].replace(/\[quality\]/g, levelProp).replace(/\[sign\]/g, sign);
