...
let h=drillsStatus[0].filter(function(drill) { return drill.id === "relative-keys" });
console.log(h[0].drill.name);

if (drillsStatus.filter(function(drill) { return drill.id === "relative-keys" }).length == 0) {
