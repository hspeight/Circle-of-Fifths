...
let LEV = attributes.drillStatus.filter((e) => e.drill === 'perfect-intervals')[0];
if (LEV !== undefined) {
    console.log(LEV.level);
} else {
    console.log('NOT DEFINED');
    attributes.drillStatus.push(JSON.parse('{"drill": "perfect-intervals", "level":  7, "completed": false}'));
}
console.log(attributes.drillStatus);

LEV = attributes.drillStatus.filter((e) => e.drill === 'perfect-intervals')[0];
if (LEV !== undefined) {
    console.log(LEV.level);
} else {
    console.log('NOT DEFINED');
    attributes.drillStatus.push(JSON.parse('{"drill": "perfect-intervals", "level":  0, "completed": false}'));
}
/*
attributes.currentDrillRef = 'relative-keys';
