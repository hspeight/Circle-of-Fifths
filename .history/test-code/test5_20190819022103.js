...
if (drillsStatus.filter(function(drill) { return drill.id === "relative-kes" }).length > 0) {
    console.log('exists');
    console.log(drillsStatus.filter(function(drill) { return drill.id === "relative-kes" }).length);
} else {
