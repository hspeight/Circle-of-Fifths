    ...
    switch (levelProp) {
        ...
        case 'flats':
           ...
           // QUESTION = keySignatureQuestions[levelProp][Q].replace(/\[number\]/g, num).replace(/\[sign\]/g, sign);
            QUESTION = Q === 0 ? keySignatureQuestions[levelProp][Q].replace(/\[number\]/g, num).replace(/\[sign\]/g, sign) :
                             keySignatureQuestions[levelProp][Q].replace(/\[key\]/g, circleWithEnharmonics[indexOfKey]['key']).replace(/\[sign\]/g, sign);
