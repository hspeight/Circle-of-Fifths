...
const Q = 0;
    let QUESTION = relativeKeyQuestions[quality][1].replace(/\[key\]/g, keyToFind).replace(/\[quality\]/g, quality); // replace placeholder with the key
    console.log(relativeKeyQuestions[quality][1]);
