...
for (i = 0; i < levelArray.length; i++) {
    ...
    //var sharps = circleWithEnharmonics[pos].keyinfo.signature.sharps;
    //var flats = circleWithEnharmonics[pos].keyInfo.signature.flats;

    console.log(pos + '/' + circleWithEnharmonics[pos].keyInfo.signature.sharps === undefined ? circleWithEnharmonics[pos].keyInfo.signature.flats + ' flats' :  circleWithEnharmonics[pos].keyInfo.signature.sharps + ' sharps');
