...
for (i = 0; i < levelArray.length; i++) {
    ...
    const Q = 0;
    let QUESTION = keySignatureQuestions[quality][Q].replace(/\[key\]/g, keyToFind).replace(/\[quality\]/g, quality); // replace placeholder with the key
