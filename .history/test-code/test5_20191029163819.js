...
var ent = {
    ...
    {
        productId: 'amzn1.adg.product.ac798b5e-fb3d-4e44-bbed-60b2be0cd014',
        referenceName: 'key-signatures',
        type: 'ENTITLEMENT',
        name: 'Key Signatures',
        summary: 'Crazy product',
        entitled: 'ENTITLED',
        entitlementReason: 'PURCHASED',
        purchasable: 'NOT_PURCHASABLE',
        activeEntitlementCount: 1,
...
let newEntitledProduct = ISPHelp.getEntitledProduct(ent.entitledProducts, 'amzn1.adg.product.ac798b5e-fb3d-4e44-bbed-60b2be0cd014');
console.log(newEntitledProduct[0].name);
...
console.log(h[0] !== undefined ? h[0] : 'No packs available for purchase');
//console.log(h[0]);


console.log(drills[0].ref);
*/
