...
for (i = 0; i < levelArray.length; i++) {
    ...
    var sharps = circleWithEnharmonics[pos].keyinfo.signature.sharps !== undefined ? circleWithEnharmonics[pos].keyinfo.signature.sharps: 0;
    var flats = circleWithEnharmonics[pos].keyinfo.signature.flats !== undefined ? circleWithEnharmonics[pos].keyinfo.signature.flats: 0;
